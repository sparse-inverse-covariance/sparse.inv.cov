...
to 'smokers', and the next 23 correspond to 'never
nmokers'. Consequently, the vector of class labels y can be
generated as
```{r, echo=TRUE,eval=FALSE}
...
The pre-processed data set is now included in the 
```{r, echo=TRUE,eval=FALSE}
library(sparse.inv.cov)
...
D[,2]<-as.numeric(y==1)
```
save to smoking.RData
```{r, echo=TRUE,eval=FALSE}
x<-rma.data
```
%The first 5 rows and columns of x should be
%X1007_s_at X1053_at X117_at X121_at X1255_g_at
%[1,] 9.729530 4.169440 5.599752 8.113206 4.
%[2,] 10.172280 4.381633 5.166447 8.025542 3.
%[3,] 9.801157 4.335081 5.696982 8.079880 3.
%[4,] 10.084170 4.025541 5.193149 7.842162 3.
%[5,] 9.765211 4.142204 5.378281 7.858246 3.
